      ...
      <div style={styles.Header}>
        <Grid container>
          <Grid item xs={2} style={styles.Left}>
            <IconButton style={styles.IconButton} component={Link} to='/'>
              <SvgIcon style={styles.Icon, {transform:'rotate(180deg)', color:'#fff', paddingRight: '11px'}}>
          ...
          <Grid item xs={8}>
              <h1
                ...
                style={{margin:'0px', marginTop: '10px', adding:'0px', color:'#fff', textAlign:'center', paddingTop:'15px', fontWeight:'300'}}
                >
                {store.name}
              </h1>
          </Grid>
